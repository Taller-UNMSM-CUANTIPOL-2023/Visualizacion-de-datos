...
#boxplot(df_lapop$m1,col = "pink") # boxplot basico de R

bp3 <- ggplot(df_pre, aes(x = "" , y = percepcion, color = "", shape = "")) +
...
```{r}
#bp3 <- ggplot(df_lapop, aes(x = q1tb, y = m1, colour = q1tb, shape = q1tb))
# + scale_shape_binned()
```
